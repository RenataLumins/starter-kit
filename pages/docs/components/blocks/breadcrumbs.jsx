...
function BreadcrumbsComponentsPage() {
	return (
		<div className="ui-typography">
			...
			<p>Создала отдельно компонент Breadcrumbs.jsx, где задала необходимые переменные (иконки, и массив с title и url). 
			<br/> В коде компонента прохожусь по циклу, чтобы вывести нужные данные. </p>
