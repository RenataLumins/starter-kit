		...
		<div className="ui-typography">
			...
			<form onSubmit={sendForm} className="tw-flex tw-flex-col tw-gap-y-[15px]">
				<input
					type="text"
					name="name"
					className={'ui-input ' + (formErrors.includes('name') ? 'ui-input-error' : '')}
					placeholder="Renata"
				/>
				...
				<Input
					name="fullname"
					label="Fullname"
					className={formErrors.includes('fullname') ? 'ui-input-error' : ''}
					placeholder="Kuznetsova"
				/>

				<Input
					name="address"
					icon="#icon-house"
					className={formErrors.includes('address') ? 'ui-input-error' : ''}
